					    	...
					    	<tbody>
					    		<?php
									...
									function news($pageNum =1, $pageSize)
									{
										...
										$rs = "select suoshurenwuid,chuangjianrenpingfen,zuoyeneirong from zuoye where chengjierenemail='{phpCAS::getUser()}' order by chengjieshijian desc limit " . (($pageNum - 1) * $pageSize) . "," . $pageSize;
									...
									function allNews()
									{
									    ...
									    mysqli_select_db($coon, "web");
									    mysqli_set_charset($coon, "utf8");
									    $rs = "select count(*) num from zuoye where chengjierenemail='{phpCAS::getUser()}'"; //可以显示出总页数
									    $r = mysqli_query($coon, $rs);
								    ...
								    if(empty($array)==false)
					    			{
								    	...
								    	{	
								    		...
								    		echo "<tr>";								    	
								    		echo "<td><a href='../renwuGUI.php?id=$values->suoshurenwuid'>{$renwuobj->zhuti}";
